                ...
                self.system_evolution_history.append(
                    {
                        ...
                        "raw_line_passenger_service_sum": partial_system_metrics[
                            "raw_line_passenger_service_sum"
                        ],
                        "naive_edge_passenger_service": partial_system_metrics[
                            "naive_edge_passenger_service"
                        ],
                        "unique_edge_passenger_service": partial_system_metrics[
