...
def run_ga_experiment(
    ...
    print("seed =", seed)
    print("od_min_to_plot =", od_min_to_plot)
    ...
    print("OD threshold used for final figure:", od_min_to_plot)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        default=10.0,
        help="Llindar OD minim per dibuixar connexions a la figura final.",
    )
